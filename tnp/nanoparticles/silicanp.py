...
from tnp.nanoparticles.silica import Silica

class SilicaNP(mb.Compound):
    def __init__(self, radius=2.0, O_layer=False):
        """Initialize an Silica Nanoparticles object.
        
        Args:
            radius (float): Radius of the nanoparticle
        """ 
        super(SilicaNP, self).__init__()
...
if __name__ == "__main__":
    n = SilicaNP(radius=9)
    n.save('SilicaNP-{}nm.mol2'.format(9))
